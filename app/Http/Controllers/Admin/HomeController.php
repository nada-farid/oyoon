...
class HomeController
{
    public function index()
    {
        ...
        $settings4 = [
            'chart_title'           => 'أحدث رسائل التواصل',
        ...
        return view('home', compact('chart6', 'chart7', 'settings1', 'settings2', 'settings3', 'settings4', 'settings5'));
    }
}
