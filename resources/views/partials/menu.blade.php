<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('about_association_access')
            <li
                class="c-sidebar-nav-dropdown {{ request()->is('admin/settings*') ? 'c-show' : '' }} {{ request()->is('admin/services*') ? 'c-show' : '' }} {{ request()->is('admin/partners*') ? 'c-show' : '' }} {{ request()->is('admin/beneficiaries*') ? 'c-show' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
        ...
        @can('support_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.supports.index') }}"
                    class="c-sidebar-nav-link {{ request()->is('admin/supports') || request()->is('admin/supports/*') ? 'c-active' : '' }}">
        ...
        @can('membership_access')
            <li
                class="c-sidebar-nav-dropdown {{ request()->is('admin/members*') ? 'c-show' : '' }} {{ request()->is('admin/membership-types*') ? 'c-show' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    ...
                    @can('membership_type_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('admin.membership-types.index') }}"
                                class="c-sidebar-nav-link {{ request()->is('admin/membership-types') || request()->is('admin/membership-types/*') ? 'c-active' : '' }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
