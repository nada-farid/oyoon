            ...
            <form method="POST" action="{{ route('admin.articles.update', [$article->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('short_description') ? 'is-invalid' : '' }}"
                        name="short_description" id="short_description">{!! old('short_description', $article->short_description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description_2') ? 'is-invalid' : '' }}" name="description_2"
                        id="description_2">{!! old('description_2', $article->description_2) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('writer_name') ? 'is-invalid' : '' }}" type="text"
                        name="writer_name" id="writer_name" value="{{ old('writer_name', $article->writer_name) }}"
                        required>
                            ...
                            return loader.file
                                .then(function(file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST',
                                            '{{ route('admin.articles.storeCKEditorImages') }}',
                                            true);
