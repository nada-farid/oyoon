    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('snap_chat') ? 'is-invalid' : '' }}" type="text" name="snap_chat" id="snap_chat" value="{{ old('snap_chat', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('initiative') ? 'is-invalid' : '' }}" name="initiative" id="initiative">{!! old('initiative') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('support_text') ? 'is-invalid' : '' }}" name="support_text" id="support_text">{{ old('support_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('membership_conditions') ? 'is-invalid' : '' }}" name="membership_conditions" id="membership_conditions">{!! old('membership_conditions') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('loss_membership') ? 'is-invalid' : '' }}" name="loss_membership" id="loss_membership">{!! old('loss_membership') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('commitments_membership') ? 'is-invalid' : '' }}" name="commitments_membership" id="commitments_membership">{!! old('commitments_membership') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('scope') ? 'is-invalid' : '' }}" name="scope" id="scope">{!! old('scope') !!}</textarea>
                @if($errors->has('scope'))
                    <div class="invalid-feedback">
                        {{ $errors->first('scope') }}
                    </div>
