        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.settings.update', [$setting->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('snap_chat') ? 'is-invalid' : '' }}" type="text"
                        name="snap_chat" id="snap_chat" value="{{ old('snap_chat', $setting->snap_chat) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('pinterest') ? 'is-invalid' : '' }}" type="text"
                        name="pinterest" id="pinterest" value="{{ old('pinterest', $setting->pinterest) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('donation_url') ? 'is-invalid' : '' }}" type="text"
                        name="donation_url" id="donation_url" value="{{ old('donation_url', $setting->donation_url) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('about_inner_photo') ? 'is-invalid' : '' }}"
                        id="about_inner_photo-dropzone">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('logo_white') ? 'is-invalid' : '' }}"
                        id="logo_white-dropzone">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('chairman_description') ? 'is-invalid' : '' }}"
                        type="text" name="chairman_description" id="chairman_description"
                        value="{{ old('chairman_description', $setting->chairman_description) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('vision') ? 'is-invalid' : '' }}" name="vision"
                        id="vision">{!! old('vision', $setting->vision) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('mission') ? 'is-invalid' : '' }}" name="mission"
                        id="mission">{!! old('mission', $setting->mission) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('values') ? 'is-invalid' : '' }}" name="values"
                        id="values">{!! old('values', $setting->values) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('initiative') ? 'is-invalid' : '' }}" name="initiative"
                        id="initiative">{!! old('initiative', $setting->initiative) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('support_text') ? 'is-invalid' : '' }}" name="support_text"
                        id="support_text">{{ old('support_text', $setting->support_text) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('membership_conditions') ? 'is-invalid' : '' }}"
                        name="membership_conditions" id="membership_conditions">{!! old('membership_conditions', $setting->membership_conditions) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('loss_membership') ? 'is-invalid' : '' }}"
                        name="loss_membership" id="loss_membership">{!! old('loss_membership', $setting->loss_membership) !!}</textarea>
                ...
                <div class="form-group">
                    <label
                        for="commitments_membership">{{ trans('cruds.setting.fields.commitments_membership') }}</label>
                    <textarea class="form-control ckeditor {{ $errors->has('commitments_membership') ? 'is-invalid' : '' }}"
                        name="commitments_membership" id="commitments_membership">{!! old('commitments_membership', $setting->commitments_membership) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('scope') ? 'is-invalid' : '' }}" name="scope"
                        id="scope">{!! old('scope', $setting->scope) !!}</textarea>
                    @if ($errors->has('scope'))
                        <div class="invalid-feedback">
                            {{ $errors->first('scope') }}
                        </div>
