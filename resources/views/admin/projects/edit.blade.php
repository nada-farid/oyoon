            ...
            <form method="POST" action="{{ route('admin.projects.update', [$project->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" name="short_description"
                        id="short_description">{{ old('short_description', $project->short_description) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text"
                        name="start_date" id="start_date" value="{{ old('start_date', $project->start_date) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text"
                        name="address" id="address" value="{{ old('address', $project->address) }}" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('beneficiar') ? 'is-invalid' : '' }}"
                        name="beneficiar_id" id="beneficiar_id">
                        @foreach ($beneficiars as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('beneficiar_id') ? old('beneficiar_id') : $project->beneficiar->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                        @endforeach
                    </select>
