    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.volunteers.update", [$volunteer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $volunteer->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $volunteer->name) }}" required>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $volunteer->phone) }}" required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identity') ? 'is-invalid' : '' }}" type="text" name="identity" id="identity" value="{{ old('identity', $volunteer->identity) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('skills') ? 'is-invalid' : '' }}" name="skills" id="skills" required>{{ old('skills', $volunteer->skills) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('experience') ? 'is-invalid' : '' }}" name="experience" id="experience" required>{{ old('experience', $volunteer->experience) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('volunteer_befor') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="volunteer_befor" id="volunteer_befor" value="1" {{ $volunteer->volunteer_befor || old('volunteer_befor', 0) === 1 ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('initiative_name') ? 'is-invalid' : '' }}" type="text" name="initiative_name" id="initiative_name" value="{{ old('initiative_name', $volunteer->initiative_name) }}" required>
